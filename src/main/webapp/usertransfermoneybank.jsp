...
%> 
    ...
    <form action="usertransfermoneybank" method="post">
        <div class="container"> 
            <h2>Amount Transfer Page</h2> 
            <input type="text" placeholder="Enter Amount to transfer" name="amount" required>
            <input type="text" placeholder="Enter Account Number" name="accnumber" required>
            <input type="text" placeholder="Enter IFSC Number" name="IFSC" required>
